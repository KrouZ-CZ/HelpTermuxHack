...
print("СсылкаGREEN на канал YouTube: https://www.youtube.com/channel/UCgOiS_SjmIVK30TmDiVgo-A")
print("")
print( Froge.CYANRED )
...
print("")
print("За использование утелит связанных со взломами я ответственность не несу они были представлены только в ознакомительный целях")
print("")
print("                                                           v1.0 release")
